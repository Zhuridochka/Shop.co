(() => {
    ...
    (() => {
        ...
        var wNumb = __webpack_require__(935);
        var PipsMode;
        (function(PipsMode) {
        ...
        function initSliders() {
            if (document.querySelector(".customers__slider")) {
                const swiperCustomers = new swiper_core_Swiper(".customers__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                    ...
                    on: {
                        slideChange: function() {
                            ...
                            if (slides[targetIndex]) slides[targetIndex].classList.add("blur-effect");
                            if (slides[prevIndex]) slides[prevIndex].classList.add("blur-effect");
                        }
                    }
                });
            }
            const swiperPreviewsProduct = new swiper_core_Swiper(".previews-slider-product", {
                modules: [ Thumb ],
                slidesPerView: 3,
                spaceBetween: 12,
                breakpoints: {
            ...
            if (document.querySelector(".like__slider")) {
                new swiper_core_Swiper(".like__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
        ...
        function windowLoaded() {
            let documentActions = e => {
                ...
                if (targetElement.closest(".menu__item")) document.documentElement.classList.toggle("shop-open"); else if (!targetElement.closest(".menu__item")) document.documentElement.classList.remove("shop-open");
                if (targetElement.closest(".filter-button")) {
                    if (window.innerWidth < 768) document.documentElement.classList.toggle("filter-open");
                } else if (!targetElement.closest(".content-category__filter")) document.documentElement.classList.remove("filter-open");
            };
            function updateHeightObjectsMenuBody() {
                ...
                if (header) if (window.innerWidth < 767.98) menuBody.style.paddingTop = `${headerHeight + 10}px`;
            }
            ...
            function updateDataAttributeBaseOnHeight() {
                ...
                if (arrivalsItems) arrivalsItems.dataset.showmoreContent = itemProductHeight;
                if (sellingItems) sellingItems.dataset.showmoreContent = itemProductHeight;
                if (likeItems) likeItems.dataset.showmoreContent = itemProductHeight;
            }
            ...
            function updateDataAttributeReviewOnHeight() {
                ...
                if (ratingReviewsBlock) ratingReviewsBlock.dataset.showmoreContent = doubleblockContentHeight;
            }
            updateDataAttributeReviewOnHeight();
            const reviewActivities = document.querySelectorAll(".review__activity");
            if (reviewActivities.length > 0) reviewActivities.forEach((reviewActivity => {
                ...
                document.addEventListener("click", (function(event) {
                    if (!reviewList.contains(event.target) && !button.contains(event.target)) {
                        reviewList.classList.remove("activity-review__list--open");
                        reviewList.classList.add("activity-review__list--close");
                    }
                }));
            ...
            if (deleteButtons.length > 0) deleteButtons.forEach((button => {
